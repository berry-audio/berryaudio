...
class DisplaySSD1322:
    def __init__(self, contrast=255, core=None):
        ...
        self.list_scrollable = WidgetListScrollable(display_width=self.width, display_height=self.height, font_size=8, font_path=FONT_STYLE_3)
                    ...
                    if self._page == "STANDBY":
                        if self._blink_visible:
                            ...
                            self._widget_title.draw(
                                draw, width=self.width, y=12, text=_time_now, center=True,
                            )
