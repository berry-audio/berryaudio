...
class DisplaySSD1306:
    def __init__(self, contrast=255):
        ...
        self._widget_title_volume = WidgetTextScrollable(font_size=21, font_path=FONT_STYLE_1)
    ...
    def init(self):
        ...
        if not self.running:
            ...
            logger.info("SSD1306 Display Initialized")
            ...
            with regulator:
                with canvas(self._device) as draw:
                    ...
                    if self._page == DisplayPage.VOLUME:
                        self._widget_title_volume.draw(
                            draw,
                            width=self.width,
                            y=24,
                            text=f"VOL {self._volume}",
                            center=True,
                        )
                    ...
                    if self._page == DisplayPage.NOW_PLAYING:
                        ...
                        if self._single:
                            draw.bitmap((99, 0), Image.open(ICON_SINGLE), fill="white")
